...
```
{
  ...
  "jwtSecret": "secret",
  "githubToken": "<yoursecretaccesstoken>"
}
```
...
If you were able to securely include `config/default.json` `and config/production.json` in your .gitignore file, then pushing to Heroku will omit your config files from the push.  
